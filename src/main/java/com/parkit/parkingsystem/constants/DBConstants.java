...
public class DBConstants {
    ...
    public static final String GET_TICKET = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME,"
    		...
    		+ " and t.OUT_TIME IS NULL order by t.IN_TIME desc limit 1";
    public static final String GET_LAST_TICKET = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, "
    		+ "p.TYPE from ticket t,parking p where p.parking_number = t.parking_number "
    		+ "and t.VEHICLE_REG_NUMBER=? order by t.IN_TIME desc limit 1";
    public static final String GET_COUNT_FOR_VEHICLE = "SELECT COUNT(*) AS COUNT FROM TICKET "
