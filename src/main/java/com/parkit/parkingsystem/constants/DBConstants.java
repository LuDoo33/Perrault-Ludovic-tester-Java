...
public class DBConstants {
    ...
    public static final String UPDATE_TICKET_IN_TIME = " update ticket set IN_TIME=? where ID=?";

    public static final String CHECK_PREVIOUS_CUSTOMER = "Select VEHICLE_REG_NUMBER from ticket where VEHICLE_REG_NUMBER LIKE ? limit 1";
}
